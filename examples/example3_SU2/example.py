...
prob_adjoint = Parameter(["MATH_PROBLEM= DISCRETE_ADJOINT"],LabelReplacer("MATH_PROBLEM= DIRECT"))
...
volume.addParameter(prob_adjoint)
...
hload_adj.addParameter(prob_adjoint)
...
vload_adj.addParameter(prob_adjoint)
...
# Functions
vert_disp = Function("vert_disp","VLOAD/history.csv",TableReader(0,0,(1,0)))
...
horiz_disp = Function("horiz_disp","HLOAD/history.csv",TableReader(0,0,(1,0)))
...
vol_frac = Function("vol_frac","VOLUME/history.csv",TableReader(0,0,(1,0)))
