...
# Functions
vert_disp = Function("vert_disp","VLOAD/of_refnode.dat",TableReader(0,0))
...
horiz_disp = Function("horiz_disp","HLOAD/of_refnode.dat",TableReader(0,0))
...
vol_frac = Function("vol_frac","VOLUME/of_volfrac.dat",TableReader(0,0))
